...
@Component({
  selector: 'add-branch-bank-accounts',
  templateUrl: './add-bank-accounts.component.html',
  styleUrls: ['./add-bank-accounts.component.less']
})
export class EditBranchBankAccountsComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private branchService: BranchService, public activeModal: NgbActiveModal) {
