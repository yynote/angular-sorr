...
export const GET_EQUIPMENT_TEMPLATES_REQUEST = '[Building Equipment Equipment Step] GET_EQUIPMENT_TEMPLATES';
export const GET_EQUIPMENT_TEMPLATES_REQUEST_COMPLETE = '[Building Equipment Equipment Step] GET_EQUIPMENT_TEMPLATES_REQUEST_COMPLETE';

export const EQUIPMENT_TEMPLATE_CHANGED = '[Building Equipment Equipment Step] EQUIPMENT_TEMPLATE_CHANGED';
export const SET_SELECTED_TEMPLATE = '[Building Equipment Equipment Step] SET_SELECTED_TEMPLATE';

export const COMBO_SETTINGS_CHANGE = '[Building Equipment Equipment Step] COMBO_SETTINGS_CHANGE';

export const ADD_REGISTER = '[Building Equipment Equipment Step] ADD_REGISTER';
export const REMOVE_REGISTER = '[Building Equipment Equipment Step] REMOVE_REGISTER';
export const CHANGE_REGISTER_SCALE = '[Building Equipment Equipment Step] CHANGE_REGISTER_SCALE';
export const CHANGE_REGISTER_SEQUENCE = '[Building Equipment Equipment Step] CHANGE_REGISTER_SEQUENCE';

export const UPDATE_ACTUAL_PHOTO = '[Building Equipment Equipment Step] UPDATE_ACTUAL_PHOTO';
export const UPDATE_ATTRIBUTE_PHOTO = '[Building Equipment Equipment Step] UPDATE_ATTRIBUTE_PHOTO';

export const ADD_REGISTER_FILE = '[Building Equipment Equipment Step] ADD_REGISTER_FILE';
export const RESET_EQUIPMENT_STEP = '[Building Equipment Equipment Step] RESET_EQUIPMENT_STEP';

export const GET_METERS_REQUEST = '[Building Equipment Equipment Step] GET_METERS_REQUEST';
export const GET_METERS_REQUEST_COMPLETE = '[Building Equipment Equipment Step] GET_METERS_REQUEST_COMPLETE';

export const CHANGE_PARENT_METER = '[Building Equipment Equipment Step] CHANGE_PARENT_METER';

export const RESET_EQUIPMENT_STEP_FORM = '[Building Equipment Equipment Step] RESET_EQUIPMENT_STEP_FORM';
...
export class ResetEquipmentStepForm implements StoreAction {
  readonly type = RESET_EQUIPMENT_STEP_FORM;
...
export type Action = GetEquipmentTemplateRequest | GetEquipmentTemplateRequestComplete | EquipmentTemplateChanged
  ...
  | ChangeParentMeter | ChangeRegisterSequence | ResetEquipmentStepForm | SetSelectedTemplate;
